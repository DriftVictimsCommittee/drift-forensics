...
Drift Protocol official documentation `Risks` page.
...
[https://docs.drift.trade/protocol/risk-and-safety/risks](https://docs.drift.trade/protocol/risk-and-safety/risks)

## Screenshot image

> Note: Image cropped for clarity

[assets/docs.drift.trade_protocol_risks_and_safety_risks.png](https://github.com/DriftVictimsCommittee/drift-forensics/blob/main/refs/assets/docs.drift.trade_protocol_risks_and_safety_risks.png)
...
```text
Drift Protocol > Risk and Safety > Risks
